...
<?php include ('../front/header.php');?>
  ...
  <main id="main">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row justify-content-center">
          ...
          <div class="col-md-6 col-lg-5" data-aos="zoom-in" data-aos-delay="100">
            <div class="box">
              <h4 class="title"><a href="">Légalisation simple</a></h4>
              <p class="description"><b>Procedure à respecter:</b> Timbre de 500 - l'original du copie</p>
            </div>
          </div>
          <div class="col-md-6 col-lg-5" data-aos="zoom-in" data-aos-delay="100">
            <div class="box">
              <h4 class="title"><a href="">Souche</a></h4>
              <p class="description"><b>Procedure à respecter:</b> Timbre de 1000(100)</p>
            </div>
          </div>
          <div class="col-md-6 col-lg-5" data-aos="zoom-in" data-aos-delay="100">
            <div class="box">
              <h4 class="title"><a href="">Paternité</a></h4>
              <p class="description"><b>Procedure à respecter:</b> Timbre de 500 - dépôt de signature 200 - Imprimé 100</p>
            </div>
          </div>
          <div class="col-md-6 col-lg-5" data-aos="zoom-in" data-aos-delay="100">
            <div class="box">
              <h4 class="title"><a href="">Copie intégrale acte de naissance</a></h4>
          ...
          <div class="col-md-6 col-lg-5" data-aos="zoom-in" data-aos-delay="100">
            <div class="box">
              <h4 class="title"><a href="">Certificat de vie</a></h4>
    ...
    <?php 
      include ('..//front/modal_detail.php');
      include ('..//front/modal_registre_service.php');
      include ('..//front/modal_a_propos.php');
      include ('..//front/modal_correspondance.php');
    ?>
  </main><!-- End #main -->
