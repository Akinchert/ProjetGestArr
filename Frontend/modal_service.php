...
<!-- Modal -->
    <div class="modal fade" id="legalisation" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"> <strong> <p>Cette demande nécéssite votre présence, veuillez passer au siège de l'arrondissement</p> Contactez nous: <a href="#">fakadiri@mairie.bj - 0197458474</a></strong></h5>
...
<div class="row">
                ...
                <div class="modal fade" id="copie" tabindex="-1" style="display: none;" aria-hidden="true">
